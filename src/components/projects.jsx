...
const demoItems = [
    ...
    { link: 'https://github.com/prathameshnimkar10/ai-text-summariser', text: 'AI-Text Summariser using APIs', image: 'https://picsum.photos/600/400?random=3' },
    { link: 'https://github.com/prathameshnimkar10/cancer_detect_wisconsin', text: 'Disease can Detection using AI/ML (Wisconsin dataset', image: 'https://picsum.photos/600/400?random=3' },
