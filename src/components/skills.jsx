...
const skillsData = [
  ...
  { id: 11, height: 230, name: "Azure DevOps" },
  { id: 12, height: 220, name: "Software Engineering" },
  { id: 14, height: 210, name: "Agile Methodologies" },
  { id: 15, height: 200, name: "Cloud Computing" },
