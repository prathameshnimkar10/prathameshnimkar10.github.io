...
const skillsData = [
  ...
  { id: 3, height: 210, name: "Java" },
  { id: 4, height: 230, name: "MySQL" },
  // { id: 4, height: 230, name: "OracleDB" },
  { id: 5, height: 250, name: "MongoDB" },
  ...
  { id: 10, height: 180, name: "Docker" },
  { id: 11, height: 150, name: "Kubernetes" },
  { id: 12, height: 125, name: "Jenkins" },
  { id: 13, height: 230, name: "Azure DevOps" },
  { id: 14, height: 220, name: "Software Engineering" },
  { id: 15, height: 210, name: "Agile Methodologies" },
  { id: 16, height: 200, name: "Cloud Computing" },
  // { id: 14, height: 160, name: "StarUML" },
  // { id: 16, height: 140, name: "PowerBI" },
  { id: 17, height: 110, name: "Postman" },
];
