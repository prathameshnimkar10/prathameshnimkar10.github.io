...
export default function EduDetails({ activeItem }) {
    if (!activeItem) return null;

    return (
        <div className="transition-opacity duration-300 ease-in-out w-full p-6 rounded-lg shadow-lg bg-gray-900 text-white mt-10 opacity-100">
